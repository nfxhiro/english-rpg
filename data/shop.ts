...
export const EQUIP_ITEMS: EquipItem[] = [
  ...
  { id: "hero_armor",        name: "勇者のよろい",   category: "armor", icon: "⚜️", price: 15000, description: "勇者のために作られた最高級のよろい。",           effects: { hp: 180, damageReduction: 5 },  recommendedFor: "終盤の主力装備" },
  // かぶと
  ...
  { id: "guard_helmet",      name: "まもりのかぶと",   category: "helmet", icon: "⛑️", price: 4000,  description: "守りと回復を助ける安定型のかぶと。",             effects: { hp: 40, healBonus: 1 },                    recommendedFor: "ミス対策" },
